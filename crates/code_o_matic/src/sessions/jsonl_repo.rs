...
mod tests {
    ...
    async fn append_and_reopen() {
        ...
        // when: append_entry is called with a valid message entry
    ...
    async fn fork_creates_branch() {
        ...
        // when: fork is called with the existing leaf as the fork point
        ...
        // then: a new leaf is created whose parent_id matches the fork point
